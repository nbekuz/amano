const PropertyDeveloper = ({ name, website, foundationYear, completedProjects }) => {
  return (
    <div className="dashboard-card p-6">
      ...
      <div className="flex gap-3">
        <div className="w-9 h-9 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 flex items-center justify-center cursor-pointer hover:bg-white/15 transition-colors">
