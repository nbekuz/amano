...
const PerformanceGraph = ({ data }) => {
  ...
  return (
    ...
    <div className='graph-blur w-85 h-12 absolute top-5 left-1/2 transform -translate-x-1/2 flex'> </div>
            ...
            <AreaChart data={data}>
              ...
              <Tooltip
                ...
                formatter={(value, name) => {
                  ...
                  if (name === 'yieldIncome') return [`$${value.toLocaleString()}`, 'Yield Income'];
                  return [value, name];
                }}
              />
              <Area 
