...
const MarketplaceDropdown = ({ options, value, onChange, placeholder, className = '' }) => {
  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      <button
        ...
        className="w-full bg-bg-dark border border-gray-600 rounded-lg px-4 py-2 text-gray-300 text-sm flex items-center justify-between hover:bg-gray-700 hover:text-white transition-all"
      >
      ...
      {isOpen && (
        <div className="absolute top-full left-0 right-0 mt-2 bg-bg-dark border border-gray-600 rounded-lg overflow-hidden z-50 shadow-lg">
